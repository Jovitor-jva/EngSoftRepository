...
public class OrdemDeServico implements Serializable {
	...
	public OrdemDeServico(Integer id, String observacoes, PrestadorDeServico prestadorDeServico, Cliente cliente) {
		super();
		this.id = id;
	...
	public void setTecnico(PrestadorDeServico prestadorDeServico) {
		this.prestadorDeServico = prestadorDeServico;
	}
